...
\bibitem{transpilation} Javascript nyelvi transzformációk. \url{https://thenewstack.io/javascript-transpilers-need-know/} 2017.04.28

\bibitem{chaosmonkey} Chaos Monkey. \url{https://insights.sei.cmu.edu/devops/2015/04/devops-case-study-netflix-and-the-chaos-monkey.html} 2017.04.28

\bibitem{llvmhomepage} LLVM honlap. \url{http://llvm.org} 2017.04.29

\bibitem{llvmarchitecture} LLVM könyv \url{http://www.aosabook.org/en/llvm.html} 2017.04.29

\bibitem{simplecompilerimage} Egyszerűsített fordítómodell. \url{http://www.aosabook.org/images/llvm/SimpleCompiler.png} 2017.04.29

\bibitem{lattnerhomepage} Chris Lattner weboldala. \url{http://nondot.org/~sabre/} 2017.04.29

\bibitem{clangusermanual} Clang hivatalos felhasználói dokumentáció. \url{https://clang.llvm.org/docs/UsersManual.html} 2017.05.03

\bibitem{clangdriverinternals} Clang driver leírás. \url{https://clang.llvm.org/docs/DriverInternals.html} 2017.05.03

\bibitem{clangtoolchain} Clang fordítóeszközök. \url{https://clang.llvm.org/docs/Toolchain.html} 2017.05.03

\bibitem{clangdriverimage} Clang driver szerkezet. \url{https://clang.llvm.org/docs/\_images/DriverArchitecture.png} 2017.05.03

\bibitem{clangsahomepage} Clang SA weboldal. \url{http://clang-analyzer.llvm.org} 2017.05.04

\bibitem{clangsapathsensitiveimage} Clang SA XCode integráció. \url{http://clang-analyzer.llvm.org/images/analyzer\_xcode.png} 2017.05.04

\bibitem{clangsaimage} Clang SA HTML nézet. \url{http://clang-analyzer.llvm.org/images/analyzer\_html.png} 2017.05.04

\bibitem{libclangdocs} LibClang dokumentáció. \url{https://clang.llvm.org/doxygen/group\_\_CINDEX.html} 2017.05.05

\bibitem{clangtooling} Clang könyvtárak dokumentáció. \url{https://clang.llvm.org/docs/Tooling.html} 2017.05.05

\bibitem{codecheckergit} CodeChecker kódbázis. \url{https://github.com/Ericsson/codechecker} 2017.05.05

\bibitem{getllvmpage} LLVM felhasználói dokumentáció. \url{http://llvm.org/docs/GettingStarted.html} 2017.05.05

\bibitem{checkerdevmanual} Clang SA checker dokumentáció. \url{http://clang-analyzer.llvm.org/checker\_dev\_manual.html} 2017.05.05

\bibitem{securecodingint50} INT50-CPP specifikáció. \url{https://www.securecoding.cert.org/confluence/display/cplusplus/INT50-CPP.+Do+not+cast+to+an+out-of-range+enumeration+value} 2017.05.06

\bibitem{codecheckerslide} CodeChecker szerkezet. \url{https://www.slideshare.net/GyorgyOrban/static-analysis-of-c-programs} 2017.05.08

\bibitem{qthomepage} Qt grafikus keretrendszer honlapja. \url{https://www.qt.io} 2017.05.12

\bibitem{boosthomepage} Boost C++ könyvtár honlapja. \url{http://www.boost.org} 2017.05.13

\bibitem{dockerhomepage} Docker weboldal. \url{https://www.docker.com} 2017.05.12
